...
function jkk_max_cusom_settings(){
	...
	register_setting( 'jkk_settings_group_social', 'Medlem-out' );
	...
	add_settings_field( 'medlem-link-out', 'Medlem-out', 'jkk_max_insert_social_media', 'jkk_max', 'sofia-max-social-media', array( 'for' => 'Medlem-out', 'type'=>"text" ));
